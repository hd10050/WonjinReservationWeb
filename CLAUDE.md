...
## TODO
### 다음 세션 최우선
- [ ] **어드민 모바일 사이드바 오버레이 `bg-black/20`이 "배경색 너무 짙다" 피드백에 대한 정확한 대상인지 미확인** — 전체 코드베이스에서 짙은 배경색이 이것 하나뿐이라 최선 추정으로 40%→20% 낮춤(2026-08-27), 사용자가 의도한 대상이 맞는지 다음 세션에서 확인 필요
