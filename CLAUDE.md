...
- [ ] M2 실제 도메인·Cloudflare 계정 / M3 예약 코드 일련번호 리셋 규칙 / M5 실장 자동 배정 규칙(라운드로빈 vs 수동) / M6 랜딩 디자인 콘텐츠
- [ ] 미답변 설계 공백: U2 폼 제출 성공 화면 / U3 error.vue / U8 환경변수 목록 / U10 감사 RouteMap 매핑표 / U11 i18n 키 규칙 / U13 rate limit 통합표 / U16 테스트 전략
