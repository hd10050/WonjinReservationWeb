...
| `/procedures/[category]` (4언어) | 시술 카테고리 페이지(11개) | 히어로 + 카테고리 소개 + 시술 목록(사진+고민불릿+이름) + "그 외" 폴백 링크 |
| `/procedures/[category]/[procedure]` (4언어) | 시술 상세 페이지(76개) | 콘텐츠 확보분은 전체 표시, 미확보분("그 외" 진입)은 제목+"준비 중"만(검색 noindex) |
