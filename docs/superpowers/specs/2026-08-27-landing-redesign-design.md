...
| 시술명 | 중국어 발견명(번체) | 설명(번체) |
|---|---|---|
| 가슴 확대 성형 | 豐胸手術 | 曼托圓形光面假體(美國FDA認證)/MOTIVA魔滴假體/曼托XTRA 등 브랜드별 특징. 고민: 快速回歸日常生活 / 包膜攣縮需修復 / 胸部再建 / 自然律動手感 |
| 하이브리드 가슴성형 | Hybrid胸部整形 | 假體植入+脂肪填充 병행. 고민: 自然觸感 / 特別瘦小體型 / 假體透光現象 |
| 가슴 축소 성형 | 胸部縮小手術 | 巨乳 기준 설명, 안전한 유선조직 절개. 고민: 精神壓力 / 頸腰疼痛 / 濕疹等皮膚疾病 |
| 처진 가슴 교정 | 下垂胸部矯正 | 유두-흉부하단 거리 기준 설명. 고민: 扁平下垂 / 大且下垂 / 產後下垂 / 減肥後彈力減少 |
| 가슴 재수술 | 胸部修復手術 | 1차 수술 6개월~1년 후 권장. 고민: 手感特別硬 / 大小模樣不滿意 / 想更換假體 |
| 유두 성형 [번역] | 乳頭整形／天使胸部矯正術 | 유두 직경 1cm·유륜 폭 3.5~4.5cm 기준 제시, 함몰유두/유두축소/유륜축소 수술법 설명. |
| 여성형 유방(여유증) | 女性化乳房（男性乳房發育症）／天使胸部矯正術 | 유선/지방 발달형별 수술법. 고민: 瘦弱但胸部突出 / 減肥後脂肪未減少 / 摸到硬結 / 女性化胸部突出 |
| 가슴 지방 이식 | (없음, 부록 E와 동일) | |
| 출산 후 가슴 성형 | (없음, 부록 E와 동일) | |
| 줄기세포 가슴 성형 | (사실상 없음, 부록 E와 동일) | |

### contour

| 시술명 | 중국어 발견명(번체) | 설명(번체) |
|---|---|---|
| 긴 얼굴 수술 | 長臉手術 | 1:1個人定製雙顎手術系統, 3D CT 진단→R2 GATE→SAW GUIDE/FACE PLATE→FACE GUIDE 4단계. 고민: 笑時牙齦外露 / 臉長 / 凸嘴下巴長 |
| 안면 비대칭 교정 | 面部不對稱矯正 | 1:1個人量身定製雙顎手術系統, 3D模擬手術. 고민: 中心線正常但左右下巴大小不同 / 下顎角輪廓不同 / 中心線彎曲(地包天) |
| 돌출 입 교정 | 凸嘴矯正／凸嘴手術 | 치조골 돌출 시 상하악전방분절절골술(ASO), 복합형은 양악수술. 고민: 僅牙齒凸出 / 僅嘴凸出臉不長 / 凸嘴+下巴短小 |
| 복합 안면 윤곽 | 綜合面部輪廓 | 오관·이미지 등 종합 고려. 고민: 下顎角和顴骨都凸出 / 臉大稜角分明 / 下顎部分較寬 |
| 사각 턱 수술 | 下顎角手術 | T형 절골+하악각 절제+고정핀, 3가지 변형. 고민: 正面看方形 / 下巴寬臉頰無區別 / 側面下顎角明顯 / 印象強勢 |
| 광대뼈 축소술 | 顴骨縮小術 | 4가지 세부법: 3D顴骨縮小術/I QUICK顴骨縮小術/顴骨假體/自體脂肪填充·玻尿酸. 고민: 側面顴骨發達顯凶 / 正面凹凸不平 / 前後顴骨都發達 / 左右不對稱 |
| 턱 끝 수술 | 下巴手術 | 절골/보형물/지방이식 등. 고민: 교합정상+턱김+전돌 / 하악골 발육부전 / 턱 넓고 짧음 |
| 윤곽재건복원술 | 輪廓重建修復術 | 하악각/광대/턱 부위별 재건. 고민: 심각한 비대칭 / 이차각 / 재건복원술 결과 불만족 |
| 셀프 양악수술 / 주걱턱 수술 / 무턱(하악 왜소증) 수술 / 안면윤곽 재수술 / 양악 재수술 / 수술 후 교정 | (없음, 부록 E와 동일 — 한/중 양쪽 다 없는 6개) | |

### bodyline

| 시술명 | 중국어 발견명(번체) | 설명(번체) |
|---|---|---|
| 지방 흡입 | 吸脂／抽脂 | 부위별 특징, 정밀 지방세포 분리파괴술. 고민: 脂肪量多 / 局部贅肉多 / 短期矯正體型 |
| 복부 성형술 | 腹壁整形術／腹部整形術 | 늘어진 피부 제거+분리된 복직근 봉합. 고민: 產後下垂 / 結實但贅肉下垂 / 抽脂後凹凸不平 |
| 힙업 성형 [번역] | 提臀整形／豐臀整形／臀部整形("蘋果線條") | 3가지 기법: Harvest-jet自體脂肪移植/假體植入/병행. 고민: 下垂無豐滿感 / 想穿衣顯豐滿 / 不對稱 / 下垂扁平顯腿短 / 骨盆小 / 減肥健身失敗 / 事故疾病導致組織切除 |

### reconstruction

| 시술명 | 중국어 발견명(번체) | 설명(번체) |
|---|---|---|
| 구순구개열 | 口唇顎裂／唇顎裂整形 | 1차 수술 후 2차 변형 설명, 2차 수술은 16세 이후 권장. |
| 구순열코성형 | 唇顎裂鼻部整形／口唇裂鼻整形 | 외관+기능 동시 개선. |
| 귀성형 | 耳朵整形／耳部整形 | 埋線刀耳矯正術, 耳後三角皮瓣切開術 2가지 수술법. |
